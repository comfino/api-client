...
trait ClientTestTrait
{
    ...
    {
        $apiClient = $this->initApiClient('/v1/user/is-active', 'GET', null, null, json_encode(true), null, 'API-KEY');
        $response = $apiClient->isShopAccountActive();

        $this->assertTrue($response);

        $apiClient = $this->initApiClient('/v1/user/is-active', 'GET', null, null, json_encode(false), null, 'API-KEY');
        $response = $apiClient->isShopAccountActive();
    ...
    public function testCreateOrder(): void
    {
        ...
        $apiClient = $this->initApiClient('/v1/orders', 'POST', null, $jsonRequest, $jsonResponse, 'API-KEY');
    ...
    public function testGetOrder(): void
    {
        ...
        $apiClient = $this->initApiClient(sprintf('/v1/orders/%s', $orderId), 'GET', null, null, $jsonResponse, 'API-KEY');
    ...
    public function testGetProductTypes(): void
    {
        ...
        $apiClient = $this->initApiClient('/v1/product-types', 'GET', null, null, json_encode($productTypesWithNames), 'API-KEY');
    ...
    public function testGetWidgetKey(): void
    {
        ...
        $apiClient = $this->initApiClient('/v1/widget-key', 'GET', null, null, json_encode($widgetKey), 'API-KEY');
    ...
    public function testGetWidgetTypes(): void
    {
        ...
        $apiClient = $this->initApiClient('/v1/widget-types', 'GET', null, null, json_encode($widgetTypesWithNames), 'API-KEY');
